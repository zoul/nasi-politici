    ...
    <div>
      <div className={styles.about}>
        ...
        <p className={styles.textBlock}>
          ...
          debatu. Nehodnotí se politická prohlášení, hodnotící soudy a predikce dopadů nějakých opatření („opatření vlády
          XY je dobré, neboť způsobí růst zaměstnanosti), jednoduše proto, že je není možné ověřit – budoucnost neznáme
          nikdo a u hodnotových soudů nelze nalézt jedinou „správnou“ pozici. Více o metodice dat se dočtete na stránkách
          Demagog.cz.
        </p>
